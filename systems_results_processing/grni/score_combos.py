...
def score_grn(input_csv, boolean_csv, active_tfs):
    ...
    # Update states until convergence or cycle detected
...
if __name__ == '__main__':
    if len(sys.argv) != 5:  # We'll add a new parameter for combination size
    ...
    combo_size = int(sys.argv[4])  # New parameter for combination size
    ...
    if os.path.exists(grni_csv) and os.path.exists(boolean_csv):
        ...
        # Define your specific list of TFs
        ...
        results = []
        update_interval = 100  # Adjust the interval as needed
        counter = 0
        ...
        for combination in tf_combinations:
            ...
            # Print progress every 'update_interval' combinations
