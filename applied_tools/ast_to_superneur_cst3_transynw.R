...
#cmdLine22 <- "Rscript code/SynergisticCore_noExpCutoff_sizeNormalization.R /storage/sisifo/for_transsynw/cst3/all_combined_gene_expression_matrix.tsv ::L5_ET:: from_other_N_to5ET /storage/sisifo/for_transsynw/cst3/nncell_annotation.tsv /storage/sisifo/for_transsynw/cst3/otherN_gene_expression_matrix.tsv Mouse cst3::el5"

args <- simulateArgs(cmdLine)
#*args <- simulateArgs(cmdLine2)
